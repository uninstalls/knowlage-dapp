...
class BetToken extends ContractPlugin {
  constructor(vue) {
    super({ fileName: 'BetToken' }, vue)
  }
}

class GamblingToken extends ContractPlugin {
  constructor(vue) {
    super({ fileName: 'GamblingToken' }, vue)
  }
}

class TestRoom extends ContractPlugin {
  constructor(vue) {
    super({ fileName: 'TestRoom' }, vue)
  }
}

export default {
  install(Vue) {
    Vue.prototype.BetToken = BetToken;
    Vue.prototype.GamblingToken = GamblingToken;
    Vue.prototype.TestRoom = TestRoom;
  }
}